...
public class JdbcComponent {
  ...
  public List<TableMetadata> tableMeta(String tableName) {
    ...
    List<TableMetadata> metaProperties = new ArrayList<TableMetadata>(columnCount);

    for (int i = 1; i <= columnCount; i++) {

      TableMetadata metaProperty = new TableMetadata();
